...
const Navbar = () => {
  ...
  return (
    <div className={`fixed top-0 z-10 w-screen min-w-[350px] h-[10vh] min-h-[70px] ${mode ? 'bg-zinc-900' : 'bg-white'} grid grid-cols-2 px-7 py-1`}>
      ...
      <div className='flex items-center gap-4 justify-self-end'>
        ...
        <NavLink className='hidden md:inline' to={'/cart'} >
        ...
        <div className={`${menu ? 'absolute overflow-y-hidden' : 'hidden'} lg:hidden ${mode ? 'bg-zinc-800 text-white' : 'bg-white'} w-[100vw] md:w-[100vw] h-[90vh] min-h-[80vh] z-1 top-[10vh] right-0`}>
